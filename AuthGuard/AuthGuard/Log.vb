...
Public Class frmLog
    ...
    Private Sub Log_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            frmLock.TrayIcon.BalloonTipText = Application.ProductName & " - Restart Program to Create Log File"
        ...
        If txtFile.Text <> "" Then
            ...
            txtFile.Text = txtFile.Text & vbCrLf + DateAndTime.Today & " " & Format(TimeOfDay, "HH:mm:ss") & " Log Accessed"
        Else
            txtFile.Text = IO.File.ReadAllText(Filename)
        End If
    ...
    Private Sub tmrLogUpdate_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tmrLogUpdate.Tick
        ...
        Else
            ...
            Dim fs As FileStream = File.Create(Filename)
            frmLock.TrayIcon.Visible = True
            frmLock.TrayIcon.BalloonTipText = Application.ProductName & " - Creating Log File"
            frmLock.TrayIcon.BalloonTipTitle = Application.ProductName
            frmLock.TrayIcon.ShowBalloonTip(1)
        End If
    End Sub
